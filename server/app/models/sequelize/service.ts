...
export abstract class DBService<Model extends Record<string, unknown>>
  implements IDBService<Model>
{
  ...
  abstract getAll(): Promise<Array<Partial<Model>>> | unknown;
}
